package com.cafebabe.phosphor.util.pdfUtils.util;
...
import com.cafebabe.phosphor.util.pdfUtils.exception.FreeMarkerException;
...
public class FreeMarkerUtil {
    ...
    /**
     * @param fileName PDF文件名    (order_10000.pdf)
     * @return 匹配到的模板名
...
//        String templatePath = classpath + "/templates";
        String templatePath =  "/D:/SourceCode/JAVA/JavaEE/phosphor/src/main/webapp/templates";
