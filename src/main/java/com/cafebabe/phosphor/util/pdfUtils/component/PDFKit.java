package com.cafebabe.phosphor.util.pdfUtils.component;
...
import com.cafebabe.phosphor.util.pdfUtils.component.builder.HeaderFooterBuilder;
import com.cafebabe.phosphor.util.pdfUtils.component.builder.PDFBuilder;
import com.cafebabe.phosphor.util.pdfUtils.exception.PDFException;
import com.cafebabe.phosphor.util.pdfUtils.util.FreeMarkerUtil;
...
public class PDFKit {
     ...
     *
     */
    public File exportToFile(String fileName,Object data){
    ...
    private  String  getDefaultSavePath(String fileName){
        ...
        String saveFilePath="C:\\Users\\lnt20\\"+fileName;
    ...
    public static String getFontPath() {
        //String classpath=PDFKit.class.getClassLoader().getResource("").getPath();
        String fontpath= "/D:/SourceCode/JAVA/JavaEE/phosphor/src/main/webapp/fonts";
        return fontpath;
    }
